...
} from "src/components/theme-layouts/themeLayoutConfigs";
...
function FuseSettings(props: FuseSettingsProps) {
  ...
  const layoutFormConfigs = useMemo(
    () => themeLayoutConfigs[formLayoutStyle].form,
    [formLayoutStyle]
  );
  ...
  return (
    <Root>
      <div className="FuseSettings-formGroup">
        ...
        <Typography className="text-md my-4 italic" color="text.secondary">
